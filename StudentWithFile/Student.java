...
class StudentRecorder {
   ...
   static ArrayList<HashMap<String, String>> createStudentMapList(ArrayList<Student> students){
        ArrayList<HashMap<String, String>> studentMapList = new ArrayList<HashMap<String, String>>();
        for(Student s : students){
